...
/* package hs-canada-0.1 */
#ifndef VERSION_hs_canada
#define VERSION_hs_canada "0.1"
#endif /* VERSION_hs_canada */
#ifndef MIN_VERSION_hs_canada
#define MIN_VERSION_hs_canada(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_hs_canada */
...
#define CURRENT_COMPONENT_ID "hs-canada-0.1-inplace-hs-canada"
